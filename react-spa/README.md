# Frontend for application listing (based on Auth0's quickstart React SDK sample application)

After starting the nodejs-rs256 backend, check the configuration in the .env file and start this frontend with `npm start`.
The listing of applications with the actions will be available in a new tab but only for users with role "Manager".

# Auth0 React SDK Sample Application (with added Applications list)
